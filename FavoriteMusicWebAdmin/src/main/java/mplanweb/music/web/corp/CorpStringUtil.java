...
public class CorpStringUtil {

	private CorpStringUtil() {
	}
	...
	public static String getTmsEncryptoAesForString(String str) {
		...
		try {
			if (str != null && !str.equals("")) {
				result = CorpEncryptionUtil.encrypto(str, AES_KEY);
			}
		} catch (Exception e) {
			result = null;
		}
	...
	public static String getTmsDecryptoAesForString(String str) {
		...
		try {
			if (str != null && !str.equals("")) {
				result = CorpEncryptionUtil.decrypto(str, AES_KEY);
			}
		} catch (Exception e) {
			result = null;
		}
	...
	public static String getEncrypto(String str) {
		...
		try {
			if (str != null && !str.equals("")) {
				result = CorpEncryptionUtil.encryptSHA256(str);
			}
		} catch (Exception e) {
			result = null;
		}
