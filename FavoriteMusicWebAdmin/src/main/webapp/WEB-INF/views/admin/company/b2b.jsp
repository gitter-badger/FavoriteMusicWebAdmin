...
<body class="skin-red sidebar-mini">
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<h1>
				Favorite Music <small>B2B관리</small>
			</h1>
			<ol class="breadcrumb">
				<li><a href="<%=request.getContextPath()%>/main.do"><i
						class="fa fa-dashboard"></i> Home</a></li>

				<li class="active">B2B관리</li>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="panel panel-default">
								...
								<div class="panel-heading">B2B관리</div>
						...
						<div class="modal-dialog">
							...
							<div class="modal-content">
								...
								<div class="modal-header">
									...
									<h4 class="modal-title" id="myModalLabel">B2B 관리/수정</h4>
								</div>
								...
								<div class="modal-body">
									...
									<div class="form-group">
										<label for="b2bname" class="col-sm-2 control-label">회사명
										</label>
										<div class="col-sm-10">
											<input type="text" id="b2bname" name="b2bname"
												class="form-control" placeholder="회사명 입력하세요">
										</div>
									</div>
									<div class="form-group">
										<label for="b2bphone" class="col-sm-2 control-label">대표전화번호
										</label>
										<div class="col-sm-10">
											<input type="text" class="form-control" id="b2bphone"
												name="b2bphone" placeholder="전화번호  입력하세요">
										</div>
									</div>
									<div class="form-group">
										<label for="b2baddress" class="col-sm-2 control-label">주소
										</label>
										<div class="col-sm-10">
											<input type="text" class="form-control" id="b2baddress"
												name="b2baddress" placeholder="주소  입력하세요">
										</div>
									</div>
									<div class="form-group">
										<label for="b2bbn" class="col-sm-2 control-label">사업자등록번호
										</label>
										<div class="col-sm-10">
											<input type="text" class="form-control" id="b2bbn"
												name="b2bbn" placeholder="사업자등록번호  입력하세요">
										</div>
									</div>
									<div class="form-group">
										<label for="b2bcontents" class="col-sm-2 control-label">내용
										</label>
										<div class="col-sm-10">
											<textarea style="height: 200px; width: 100%;"
												id="b2bcontents" name="b2bcontents">
											</textarea>
											<script>
												CKEDITOR.replace('b2bcontents');
											</script>
										</div>
									</div>
									<div class="form-group">
		...
		<strong> &copy; Copyright <a href="#">VM! Media Contents
				Labs</a>
		</strong> All rights reserved. <strong>2009~2015 </strong> </footer>
		<!-- Control Sidebar -->
	...
	<script
		...
		type="text/javascript"></script>
	<script
		src="<%=request.getContextPath()%>/resources/homepage/js/company/b2bview.js"></script>
</body>
</html>
