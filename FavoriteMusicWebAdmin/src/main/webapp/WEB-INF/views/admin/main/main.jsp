...
<div class="wrapper"> 
  ...
  <header class="main-header"> 
    ...
    <span class="logo-lg">Favorite Music</span> </a> 
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-center"> <a href="#" class="btn btn-default btn-flat">Sign out</a> </div>
              </li>
            </ul>
          </li>
  ...
  <div class="content-wrapper"> 
    ...
    <section class="content-header">
      <h1> Favorite Music <small>DashBoard Version 0.1</small> </h1>
      <ol class="breadcrumb">
  ...
  <footer class="main-footer"> 
    ...
    <!-- Default to the left --> 
    <strong>&copy; Copyright <a href="#">M!Plan</a></strong> All rights reserved. <strong>1997~2015 </strong> <br/>
    <strong> &copy; Copyright <a href="#">VM! Media Contents Labs</a></strong> All rights reserved. <strong>2009~2015 </strong> </footer>
