...
<link rel="stylesheet" type="text/css"
	href="<%=request.getContextPath()%>/resources/icheck/skins/all.css">
<link rel="stylesheet" type="text/css"
	href="<%=request.getContextPath()%>/resources/homepage/css/admin.css">
<script
...
%>
<video id="movie" poster="/movie/music.png" preload="auto" autoplay loop
	autobuffer muted
	style="width: 1270px; height: 714px; display: inline; margin-left: 0px;">
...
<body>
	<div id="box">
		...
		<form name="login3" action="j_spring_security_check" method="post">
			...
			<div class="pass">
				<label> <input type="checkbox" class="flat-red" /> 로그인 상태
					유지
				</label>
			</div>

			<input type="button" value="계정찾기" onclick="login()" /> <input
				type="button" value="비밀번호찾기" onclick="login()" />
	...
	<script
		src="<%=request.getContextPath()%>/resources/icheck/icheck.min.js"></script>
	<script type="text/javascript">
		$(function() {
...
<script
	src="<%=request.getContextPath()%>/resources/homepage/js/main.js"
