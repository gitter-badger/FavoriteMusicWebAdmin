						...
						<div class="modal-dialog">
							...
							<div class="modal-content">
								...
								<div class="modal-body">
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<label class="radio-inline"> <input type="radio"
												...
												id="titleuse1" name="titleuse1" value="N">타이틀곡 아님
											</label>
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<label for="title" class="col-sm-2 control-label">타이틀
										</label>
										<div class="col-sm-10">
									...
									<div class="form-group">
										<label for="lyric" class="col-sm-2 control-label">내용 </label>
										<div class="col-sm-10">
...
<script
	...
	<script
		...
		type="text/javascript"></script>
	<script
		src="<%=request.getContextPath()%>/resources/homepage/js/musicview.js"></script>
</body>
</html>
